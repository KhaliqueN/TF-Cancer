...
tgenet <- c()
tsplice <- c()
wb1 <- openxlsx::createWorkbook(paste0(save_dir,'/Supplementary_file_S5.xlsx'))
...
for(k in 1:length(all_cancer)){
    ...
    openxlsx::saveWorkbook(wb1, paste0(save_dir,'/Supplementary_file_S5.xlsx'), overwrite = T)
}
